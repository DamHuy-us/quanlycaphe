...
public class BranchMilkTeaServiceImpl implements IBranchMilkTeaService {
	...
	@Override
	public BranchMilkTea getByBranchIDAndMilkTeaID(int branchID, int milkTeaID) {
		return iBranchMilkTeaRepository.findByBranchIDAndMilkTeaID(branchID, milkTeaID);
	}
