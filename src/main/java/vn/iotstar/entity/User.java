...
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(exclude = {"orders", "rates", "shippers", "userMilkTeaRates", "userMilkTeaLikes", "role"})
@ToString(exclude = {"orders", "rates", "shippers", "userMilkTeaRates", "userMilkTeaLikes", "role"})
public class User {
    @Id
