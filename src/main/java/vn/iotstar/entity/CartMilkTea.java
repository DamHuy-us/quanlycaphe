...
public class CartMilkTea {
    ...
    public BigDecimal getTotalPrice() {
        if (milkTea != null && milkTea.getDiscountPrice() != null) {
            BigDecimal extraCost = (size != null && size.getExtraCost() != null) ? size.getExtraCost() : BigDecimal.ZERO;
            return milkTea.getDiscountPrice().add(extraCost).multiply(BigDecimal.valueOf(quantityMilkTea));
        }
