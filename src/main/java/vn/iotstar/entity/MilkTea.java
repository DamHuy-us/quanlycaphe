...
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(exclude = {"branches", "branchMilkTeas", "userMilkTeaRates", "userMilkTeaLikes"})
@ToString(exclude = {"branches", "branchMilkTeas", "userMilkTeaRates", "userMilkTeaLikes"})
